...
Default C decompiler output

```c
f32 func_8026B1D4(s32);                             /* extern */
extern ? lbl_80459278;
extern u32 lbl_804D6558;
extern f32 lbl_804D82E0;

f32 func_8007BBCC(HSD_GObj* arg0) {
    ?* var_r31;
    f32 var_f31;
    s32 temp_r0;
    u32 var_r30;
    ...
    if ((u32) lbl_804D6558 != 0U) {
        var_r31 = &lbl_80459278;
        var_r30 = 0U;
loop_12:
        if (var_r30 < (u32) lbl_804D6558) {
            temp_r0 = var_r31->unk0;
            switch (temp_r0) {                      /* irregular */
            case 1:
                temp_r3 = var_r31->unkC;
                if ((u32) temp_r3->unk30 == 0xFU) {
                    var_f31 += temp_r3->unkC;
                }
                break;
            case 2:
                if ((u32) var_r31->unkC->unk30 == 0xFU) {
                    var_f31 += func_8026B1D4(var_r31->unk8);
                }
                break;
            }
            var_r31 += 0x28;
...
Here's the C context I'm using. So don't redefine anything in here
